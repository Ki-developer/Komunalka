...
| Проблема | Решение |
|---|---|
| *«Не удалось открыть файл»* или другая ошибка Google | В браузере выполнен вход в несколько Google-аккаунтов. Откройте ссылку в режиме инкогнито или оставьте один аккаунт. |
